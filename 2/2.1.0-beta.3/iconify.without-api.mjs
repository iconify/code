...
export { addCollection, addIcon, buildIcon, calculateSize, getIcon, getVersion, iconExists, listIcons, observe, pauseObserver, renderHTML, renderIcon, renderSVG, replaceIDs, resumeObserver, scan, stopObserving };
